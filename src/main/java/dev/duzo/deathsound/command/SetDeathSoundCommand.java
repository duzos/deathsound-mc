package dev.duzo.deathsound.command;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.builder.RequiredArgumentBuilder;
import dev.duzo.deathsound.DeathSoundMod;
...
public class SetDeathSoundCommand {
	public static void register(CommandDispatcher<CommandSourceStack> stack) {
		...
		stack.register(Commands.literal(DeathSoundMod.MODID).then(requiredargumentbuilder));
	}
